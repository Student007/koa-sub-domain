...
[![Stories in Progress](https://badge.waffle.io/Student007/koa-sub-domain.png?label=In%20Progress&title=In%20Progress)](https://waffle.io/Student007/koa-sub-domain) [![Build Status](https://travis-ci.org/Student007/koa-sub-domain.svg)](https://travis-ci.org/Student007/koa-sub-domain) ![Dependency](https://david-dm.org/student007/koa-sub-domain.svg) [![npm version](https://badge.fury.io/js/koa-sub-domain.svg)](http://badge.fury.io/js/koa-sub-domain)
# koa-sub-domain
